...
<div class="app-content-area">
    ...
    <div class="container-fluid mt-n22">
        ...
        <!-- Validation Form -->
        <form action="{{ route('simpandataadmin') }}" method="POST" style="background-color: white; border-radius: 5px; padding-bottom: 20px;" class="row g-3 needs-validation" novalidate>
            @csrf
            <div class="col-md-5">
