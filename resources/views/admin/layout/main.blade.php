...
<!-- Mirrored from dashui.codescandy.com/dashuipro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2024 02:43:06 GMT -->
...
<body>
            ...
            <div class="navbar-vertical navbar nav-dashboard">
                <div class="h-100" data-simplebar>
                    ...
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <!-- Nav item -->
                        <li class="nav-item">
                            <a class="nav-link has-arrow " href="/admin-dashboard">
                                <i class="nav-icon me-2 icon-xxs bi bi-house"></i>
                                Dashboard
                            </a>
                        </li>
                        <!-- Nav item -->
                        <li class="nav-item">
                            <a class="nav-link has-arrow  collapsed " href="#" data-bs-toggle="collapse"
                                ...
                                <i class="nav-icon me-2 icon-xxs bi bi-people"></i>
                                Kelola Akun
                            </a>
                            <div id="navecommerce" class="collapse " data-bs-parent="#sideNavbar">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link has-arrow " href="/data-admin">Data Admin</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link has-arrow " href="/data-industri">Data Industri</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link has-arrow " href="/data-sekolah">Data Sekolah</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link has-arrow " href="/data-user">Data User</a>
                                    </li>
                                </ul>
                            </div>
                        <li class="nav-item">
                            <a class="nav-link has-arrow " href="/laporan-gaji">
                                <i data-feather="message-square" class="nav-icon me-2 icon-xxs"></i>
                                Laporan Gaji
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link has-arrow " href="/report">
                                <i data-feather="message-square" class="nav-icon me-2 icon-xxs"></i>
                                Report
                            </a>
                        </li>
    ...
    <script src="dashuipro/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="dashuipro/assets/libs/feather-icons/dist/feather.min.js"></script>
    <script src="dashuipro/assets/libs/simplebar/dist/simplebar.min.js"></script>

    <!-- Theme JS -->
    <script src="dashuipro/assets/js/theme.min.js"></script>

    <script src="dashuipro/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
    <script src="dashuipro/assets/js/vendors/chart.js"></script>
</body>

<!-- Mirrored from dashui.codescandy.com/dashuipro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Oct 2024 02:44:02 GMT -->
